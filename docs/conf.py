# -*- coding: utf-8 -*-
#
# pytest-enhanced-reports documentation build configuration file, created by
...
project = 'pytest-enhanced-reports'
copyright = '2015, NewPage Solutions'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-enhanced-reports Documentation',
     [author], 1)
]
